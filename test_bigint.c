...
static void test_mul_bigint(void)
{
  test_case_bigint_two_operands cases[] = {
    { BIGINT(NON_NEGATIVE,0x12,0x34,0x56,0x78),BIGINT(NON_NEGATIVE,0x12,0x34), BIGINT(NON_NEGATIVE,0x01,0x4B,0x60,0xB6,0x00,0x60) },
    ...
    { BIGINT(NON_NEGATIVE,0x00), BIGINT(NON_NEGATIVE,0x00), BIGINT(NON_NEGATIVE,0x00) },
    { BIGINT(NON_NEGATIVE,0x00), BIGINT(NON_NEGATIVE,0x15), BIGINT(NON_NEGATIVE,0x00) },
    { BIGINT(NON_NEGATIVE,0xAB,0xCD), BIGINT(NON_NEGATIVE,0x00), BIGINT(NON_NEGATIVE,0x00) },
    { BIGINT(NON_NEGATIVE,0x01), BIGINT(NON_NEGATIVE,0x99), BIGINT(NON_NEGATIVE,0x99) },
    { BIGINT(NON_NEGATIVE,0x12,0x34), BIGINT(NON_NEGATIVE,0x01), BIGINT(NON_NEGATIVE,0x12,0x34) },
    { BIGINT(NEGATIVE,0x05), BIGINT(NON_NEGATIVE,0x10), BIGINT(NEGATIVE,0x50) },
    { BIGINT(NON_NEGATIVE,0x05), BIGINT(NEGATIVE,0x10), BIGINT(NEGATIVE,0x50) },
    { BIGINT(NEGATIVE,0x05), BIGINT(NEGATIVE,0x10), BIGINT(NON_NEGATIVE,0x50) },
    { BIGINT(NEGATIVE,0xFA,0xCA), BIGINT(NON_NEGATIVE,0x02,0x03), BIGINT(NEGATIVE,0x01,0xF8,0x84,0x5E) },
    { BIGINT(NON_NEGATIVE,0xFF), BIGINT(NON_NEGATIVE,0xFF), BIGINT(NON_NEGATIVE,0xFE,0x01) },
    { BIGINT(NON_NEGATIVE,0xFF,0xFF), BIGINT(NON_NEGATIVE,0xFF,0xFF), BIGINT(NON_NEGATIVE,0xFF,0xFE,0x00,0x01) },
    { BIGINT(NON_NEGATIVE,0x80), BIGINT(NON_NEGATIVE,0x02), BIGINT(NON_NEGATIVE,0x01,0x00) },
    { BIGINT(NON_NEGATIVE,0x01), BIGINT(NON_NEGATIVE,0x12,0x34,0x56,0x78), BIGINT(NON_NEGATIVE,0x12,0x34,0x56,0x78) },
    { BIGINT(NON_NEGATIVE,0x10,0x00,0x00), BIGINT(NON_NEGATIVE,0x02), BIGINT(NON_NEGATIVE,0x20,0x00,0x00) },
    { BIGINT(NON_NEGATIVE,0x01,0x00,0x01), BIGINT(NON_NEGATIVE,0x02), BIGINT(NON_NEGATIVE,0x02,0x00,0x02) },
    { BIGINT(NON_NEGATIVE,0x80,0x00), BIGINT(NON_NEGATIVE,0x02), BIGINT(NON_NEGATIVE,0x01,0x00,0x00) },
    { BIGINT(NON_NEGATIVE,0xAA,0xAA), BIGINT(NON_NEGATIVE,0x55,0x55), BIGINT(NON_NEGATIVE,0x38,0xE3,0x1C,0x72,) },
  };
