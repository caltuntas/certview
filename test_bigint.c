...
static void test_div_bigint(void)
{
  test_case_bigint_division cases[] = {
    ...
    { BIGINT(1,0x01,0x00),BIGINT(1,0x02),BIGINT(1,0x80) },// 256 / 2 = 128
    { BIGINT(1,0x03,0x00),BIGINT(1,0x03),BIGINT(1,0x01,0x00) },
    { BIGINT(1,0xFF,0xFF),BIGINT(1,0x03),BIGINT(1,0x55,0x55) },
    { BIGINT(1,0xFF,0x00),BIGINT(1,0xFF),BIGINT(1,0x01,0x00) },
    { BIGINT(1,0xFE,0x01),BIGINT(1,0xFE),BIGINT(1,0x01,0x00) },
    { BIGINT(1,0x80,0x00),BIGINT(1,0x80),BIGINT(1,0x01,0x00) },
    { BIGINT(1,0xFF,0xFF),BIGINT(1,0x80),BIGINT(1,0x01,0xFF) },
    { BIGINT(1,0x12,0x34,0x56),BIGINT(1,0x01),BIGINT(1,0x12,0x34,0x56) },
    { BIGINT(1,0x10),BIGINT(1,0x20),BIGINT(1,0x00) },
    { BIGINT(1,0x01,0x00),BIGINT(1,0xFF),BIGINT(1,0x01) },
    { BIGINT(1,0x01,0x00,0x00),BIGINT(1,0x02),BIGINT(1,0x80,0x00) },
    { BIGINT(1,0x02,0x00,0x00),BIGINT(1,0x02),BIGINT(1,0x01,0x00,0x00) },
    { BIGINT(1,0xFF,0xFF,0xFF,0xFF),BIGINT(1,0x02),BIGINT(1,0x7F,0xFF,0xFF,0xFF) },
    { BIGINT(1,0xFF,0xFF,0xFF,0xFF),BIGINT(1,0x0F),BIGINT(1,0x11,0x11,0x11,0x11) },
    { BIGINT(1,0xAA,0xAA,0xAA),BIGINT(1,0x02),BIGINT(1,0x55,0x55,0x55) },
    { BIGINT(1,0x55,0x55,0x55),BIGINT(1,0x05),BIGINT(1,0x11,0x11,0x11) },
    { BIGINT(1,0x00,0xFF,0xFF),BIGINT(1,0x02),BIGINT(1,0x7F,0xFF) },
    { 
      BIGINT(1,0x12,0x34,0x56,0x78),
      BIGINT(1,0x12,0x34),
      BIGINT(1,0x01,0x00,0x04)
    },
    {
      BIGINT(1, 0xAA,0xBB,0xCC,0xDD),
      BIGINT(1, 0x01,0x23,0x45),
      BIGINT(1, 0x96,0x0F)
    },
    {
      BIGINT(1, 0x10,0x00,0x00,0x00),
      BIGINT(1, 0x01,0x00),
      BIGINT(1, 0x10,0x00,0x00)
    },
    {
      BIGINT(1, 0x01,0x00,0x00,0x00),
      BIGINT(1, 0xFF,0xFF),
      BIGINT(1, 0x01,0x00)
    },
    {
      BIGINT(1, 0x20,0x00,0x00,0x00),
      BIGINT(1, 0x1F,0xFF,0xFF),
      BIGINT(1, 0x01,0x00)
    },
    {
      BIGINT(1, 0xFF,0xFF,0xFF,0xFF,0xFF),
      BIGINT(1, 0xFF,0xFF),
      BIGINT(1, 0x01, 0x00, 0x01, 0x00)
    },
    {
      BIGINT(1, 0xAA,0xAA,0xAA,0xAA),
      BIGINT(1, 0x55,0x55),
      BIGINT(1, 0x02, 0x00, 0x02)
    },
    {
      BIGINT(1, 0x01,0x00,0x00,0x00,0x00),
      BIGINT(1, 0x01,0x00,0x00),
      BIGINT(1, 0x01, 0x00, 0x00)
    },
    {
      BIGINT(1, 0x12,0x34,0x56),
      BIGINT(1, 0x12,0x34,0x55),
      BIGINT(1, 0x01)
    },
    {
      BIGINT(1, 0xDE,0xAD,0xBE,0xEF,0x12,0x34),
      BIGINT(1, 0xBE,0xEF,0x01),
      BIGINT(1, 0X01, 0X2A, 0X90, 0X2C)
    },
    {
      BIGINT(1, 0xFF,0xEE,0xDD),
      BIGINT(1, 0xFF,0xEE),
      BIGINT(1, 0x01,0x00)
    },
    {
      BIGINT(1, 0x01,0x23,0x45,0x67,0x89),
      BIGINT(1, 0x01,0x23,0x45),
      BIGINT(1, 0x01,0x00,0x00)
    },
  };
